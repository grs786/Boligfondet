...
var LineChart = /** @class */ (function (_super) {
    ...
    function LineChart() {
        ...
        _this.renderScrollableDot = function (_a) {
          ...
          <TextInput onLayout={function () {
                    ...
                    <AnimatedCircle key={Math.random()} cx={translateX} cy={translateY} r={scrollableDotRadius} stroke={'red'} strokeWidth={scrollableDotStrokeWidth} fill={scrollableDotFill}/>
                ]);
            });
            return output;
        };
    ...
    LineChart.prototype.render = function () {
        ...
        <Svg height={height + paddingBottom + legendOffset} width={width - margin * 2 - marginRight}>
          <Rect width="100%" height={height + legendOffset} rx={borderRadius} ry={borderRadius} fill="white" fillOpacity={transparent ? 0 : 1}/>
